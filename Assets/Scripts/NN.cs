...
namespace NeuralNet
{
    public class NN
    {
        ...
        /// <returns></returns>
        public int CalculateNN(float[] inps)
        {
            ...
            int O = SoftSign(Sum(Ow, _hL) + Ob) < 0 ? 0 : 1;
        ...
        /// <summary>
        /// BinaryStep is an activation function that maps your input to 0 or 1
        /// </summary>
        int BinaryStep(float inp)
        {
            return inp < 0 ? 0 : 1;
        }
